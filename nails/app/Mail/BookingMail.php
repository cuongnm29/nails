...
class BookingMail extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->from($mail->driver, 'Expert Nails and Beauty family')->subject('Appointment Booking for Expert Nails and Beauty family')->markdown('mail.BookingSendMail')
