                ...
                <div class="breadcrumb-area">
                    ...
                    <div class="page-breadcrumbs">
                        <ul class="breadcrumbs-list">
                            ...
                            <li class="item"><i class="icon icon-double-right-chevron"></i></li>
                            <li class="item"><a href="#"> {{$cat_services->name}}</a></li>
                        </ul>
                ...
                <div class="single-post-wrapper blog-details">
                    <div class="content-wrapper ">
                        <div class="entry-header">
                            <h2 class="post-title"><a href="#">{{$serviceBlog->title}}</a></h2>
                            <ul class="post-meta-info">
                                <li><i class="icon icon-clock"></i> {{$serviceBlog->created_at}}</li>
                            </ul>
                            <!--end post meta info-->
                        </div>
                        <!--end entry header-->
                        <div class="post-content-area">
                            <article class="post-details">
                                <div class="post-body-content">
                                    <div class="post-des">{!!$serviceBlog->summary!!}</div>

                                    <div class="post-des">{!!$serviceBlog->content!!}</div>
                    ...
                    <div class="widget post-list-item">
                        ...
                        <div class="post-content media">
                            ...
                            <div class="media-body">
                                <h4 class="post-title">
                                    <a href="/service/{{$blog->catid}}/{{$blog->catslug}}">{{$blog->title}}</a>
                                </h4>
                                <!--end post title-->
                                <div class="post-meta">
                    ...
                    <div class="widget category">
                        ...
                        <ul class="category-list">
                            @foreach($categoriesService as $key=>$service)
                                ...
                                <li>
                                    <a href="/service/{{$child->id}}/{{$child->slug}}">{{$child->title}}</a>
